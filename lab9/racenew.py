...
bgRoad = pg.image.load("/Users/Владелец/Desktop/q/lab9/Race/bgRoad.png")
sharkIm = pg.image.load("/Users/Владелец/Desktop/q/lab9/Race/shark.png")
rocketIm = pg.image.load("/Users/Владелец/Desktop/q/lab9/Race/rocket.png")
bombIm = pg.image.load("/Users/Владелец/Desktop/q/lab9/Race/bomb.png")
...
class Cherry(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("/Users/Владелец/Desktop/q/lab9/Race/cherry.png")
...
class Coin(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("/Users/Владелец/Desktop/q/lab9/Race/coin.png")
        self.rect = self.image.get_rect()
        self.speed = 7
    def move(self):
        global money
...
class Enemy(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("/Users/Владелец/Desktop/q/lab9/Race/bomb.png")
        self.rect = self.image.get_rect()
...
class Shark(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("/Users/Владелец/Desktop/q/lab9/Race/shark.png")
        self.rect = self.image.get_rect()
...
pg.mixer.music.load("/Users/Владелец/Desktop/q/lab9/Race/bgMusic.mp3")
pg.mixer.music.play()
